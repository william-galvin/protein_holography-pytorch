...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_file', type=optional_str, default='../config/hcnn_aa_classifier/so3_convnet.yaml')
    ...
    hcnn_aa_classifier_inference(args.experiment_dir, model_name='lowest_valid_loss_model')
    hcnn_aa_classifier_inference(args.experiment_dir, model_name='highest_valid_acc_model')
    hcnn_aa_classifier_inference(args.experiment_dir, model_name='final_model')
